                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="salary_from" id="salary_from" class="form-control form-control-lg" value="15000" min="1000" step="0" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Salary Range To</label>
                                                <input type="number" name="salary_to" id="salary_to" class="form-control form-control-lg" value="25000" min="1000" step="0" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
