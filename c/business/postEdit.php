                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="salary_from" id="salary_from" class="form-control form-control-lg" min="1000" value="<?= $post['post_salary_from'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Salary Range To</label>
                                                <input type="number" name="salary_to" id="salary_to" class="form-control form-control-lg" min="1000" value="<?= $post['post_salary_to'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
